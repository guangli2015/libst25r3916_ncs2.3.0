...
#define platformTimerCreate( t )                      timerCalculateTimer(t)                                   /*!< Creates a timer with the given time (ms)    */
...
#define platformErrorHandle()                         Error_Handler()                                          /*!< Global error handle/trap                    */
